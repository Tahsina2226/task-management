...
const Register = () => {
  ...
  return (
    <div className="mx-auto mt-10 w-4/5 md:w-2/5">
      <div>
      ...
      <form
        ...
        className="my-10 border-2 border-black card-body"
      >
        {/* Name Field */}
        <div className="form-control">
          <label className="label">
            <span className="rounded-none label-text">Name</span>
          </label>
          <input
            type="text"
            placeholder="name"
            className="input-bordered rounded-none input"
        ...
        <div className="form-control">
          <label className="label">
            <span className="rounded-none label-text">Select Image</span>
          </label>
          <input
        ...
        <div className="form-control mt-6">
          <button className="bg-black rounded-none text-white btn">
            Register
          </button>
        </div>
